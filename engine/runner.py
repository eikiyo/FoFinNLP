...
# Deferred to ONE comprehensive sweep once every leaf exists (postponed per the author: 2026-06-30).
BIG_BATCH = [
...
def openrouter_model_set(label, model_id):
    ...
    models" lineup (gemma-4-31b-it first, per the author: 2026-07-02) instead of hardcoding a new

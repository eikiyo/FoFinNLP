...
class AnthropicClient(LLMClient):
    """
    Direct Anthropic Messages API client (api.anthropic.com) -- explicitly authorized by the author
    ...
    disadvantage. House rule: a bare "Haiku/Sonnet agent" elsewhere normally means an
    interactive agent seat, NEVER api.anthropic.com without explicit approval -- this class is
    ...
    Prompt caching (2026-07-03, the author: "don't we get benefit of caching?"): the harness calls
...
class OpenRouterClient(LLMClient):
    ...
    def generate(self, prompt: str, temperature: float) -> str:
        ...
        payload = {
            ...
            # gpt-5-mini on the ownership-math leaves (41-43% still empty) -- 16384 per the author:
        ...
        headers = {
            ...
            "HTTP-Referer": "https://example.invalid/probity",
            "X-Title": "Probity",
        }
        return _post_chat_completion(
